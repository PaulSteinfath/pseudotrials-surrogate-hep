function [RelativePower] = Compute_RP(signal,fs,band,frequency_band)
%{
...
INPUT:
    ...
    band: the minimum and the maximum frequencies. Format => [f_min f_max].
...
RelativePower = RelativePower / sum(PSD(ind_band));
