function surrblk = phaseran(recblk,nsurr)
    % PHASERAN Generate phase-randomized surrogate data for multivariate time series.
    %
    % Creates surrogate datasets by phase-randomizing the input time series data. 
    % This function is useful for hypothesis testing in time series analysis, 
    % where the goal is to preserve the linear properties of the data 
    % while randomizing the nonlinear structure.
    %
    % Input data
    % ----------
